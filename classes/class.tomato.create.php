...
?>
   <div id="ajaxKeywords"></div>
    ...
    function upload_tomato_with_keyword_array($userid, $title, $tomdate, $tomweek, $count, $category, $notes, $url=NULL, $keywords)
    {
        ...
        // $this->datestring();
        // day of week number
      // $weekdayno   = idate('w', $timestamp); this makes Sunday 0
        $weekdayno = date("N", $timestamp); // this makes Sunday 7
